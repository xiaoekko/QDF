...
void GUI_FillRoundedRect       (int x0, int y0, int x1, int y1, int r);					//绘制并填充一个带有圆角的矩形
...
#define GUI_BLUE          GUI_MAKE_COLOR(0x00FF0000)      //   #0000FF
#define GUI_GREEN         GUI_MAKE_COLOR(0x0000FF00)      //   #00FF00
#define GUI_RED           GUI_MAKE_COLOR(0x000000FF)      //   #FF0000
#define GUI_CYAN          GUI_MAKE_COLOR(0x00FFFF00)      //   #00FFFF
#define GUI_MAGENTA       GUI_MAKE_COLOR(0x00FF00FF)      //   #FF00FF
#define GUI_YELLOW        GUI_MAKE_COLOR(0x0000FFFF)      //   #FFFF00
#define GUI_LIGHTBLUE     GUI_MAKE_COLOR(0x00FF8080)      //   #8080FF
#define GUI_LIGHTGREEN    GUI_MAKE_COLOR(0x0080FF80)      //   #80FF80
#define GUI_LIGHTRED      GUI_MAKE_COLOR(0x008080FF)      //   #FF8080
#define GUI_LIGHTCYAN     GUI_MAKE_COLOR(0x00FFFF80)      //   #80FFFF
#define GUI_LIGHTMAGENTA  GUI_MAKE_COLOR(0x00FF80FF)      //   #FF80FF
#define GUI_LIGHTYELLOW   GUI_MAKE_COLOR(0x0080FFFF)      //   #FFFF80
#define GUI_DARKBLUE      GUI_MAKE_COLOR(0x00800000)      //   #000080
#define GUI_DARKGREEN     GUI_MAKE_COLOR(0x00008000)      //   #008000
#define GUI_DARKRED       GUI_MAKE_COLOR(0x00000080)      //   #800000
#define GUI_DARKCYAN      GUI_MAKE_COLOR(0x00808000)      //   #008080
#define GUI_DARKMAGENTA   GUI_MAKE_COLOR(0x00800080)      //   #800080
#define GUI_DARKYELLOW    GUI_MAKE_COLOR(0x00008080)      //   #808000
#define GUI_WHITE         GUI_MAKE_COLOR(0x00FFFFFF)      //   #FFFFFF
#define GUI_LIGHTGRAY     GUI_MAKE_COLOR(0x00D3D3D3)      //   #D3D3D3
#define GUI_GRAY          GUI_MAKE_COLOR(0x00808080)      //   #808080
#define GUI_DARKGRAY      GUI_MAKE_COLOR(0x00404040)      //   #404040
#define GUI_BLACK         GUI_MAKE_COLOR(0x00000000)      //   #000000
#define GUI_BROWN         GUI_MAKE_COLOR(0x002A2AA5)      //   #A52A2A
#define GUI_ORANGE        GUI_MAKE_COLOR(0x0000A5FF)      //   #FFA500
#define GUI_TRANSPARENT   GUI_MAKE_COLOR(0xFF000000)      //   #000000
														              
#define GUI_GRAY_3F       GUI_MAKE_COLOR(0x003F3F3F)      //   #3F3F3F
#define GUI_GRAY_50       GUI_MAKE_COLOR(0x00505050)      //   #505050
#define GUI_GRAY_55       GUI_MAKE_COLOR(0x00555555)      //   #555555
#define GUI_GRAY_60       GUI_MAKE_COLOR(0x00606060)      //   #606060
#define GUI_GRAY_7C       GUI_MAKE_COLOR(0x007C7C7C)      //   #7C7C7C
#define GUI_GRAY_9A       GUI_MAKE_COLOR(0x009A9A9A)      //   #9A9A9A
#define GUI_GRAY_AA       GUI_MAKE_COLOR(0x00AAAAAA)      //   #AAAAAA
#define GUI_GRAY_C0       GUI_MAKE_COLOR(0x00C0C0C0)      //   #C0C0C0
#define GUI_GRAY_C8       GUI_MAKE_COLOR(0x00C8C8C8)      //   #C8C8C8
#define GUI_GRAY_D0       GUI_MAKE_COLOR(0x00D0D0D0)      //   #D0D0D0
#define GUI_GRAY_E7       GUI_MAKE_COLOR(0x00E7E7E7)      //   #E7E7E7
#define GUI_BLUE_98       GUI_MAKE_COLOR(0x00980000)      //   #000098
...
extern GUI_CONST_STORAGE GUI_FONT GUI_FontHZ_SyrIcon_3232;
extern GUI_CONST_STORAGE GUI_FONT GUI_FontHZ_Black_1616;
/*********************************************************************
*
*       Macros to be used
*/
