...
/*  Modbus    开阀            01 05 00 00 FF 00 CRC  (ID=1, 功能码=05, Addr=0000, Data=FF00, CRC)
              关阀            01 05 00 01 FF 00 CRC  (ID=1, 功能码=05, Addr=0001, Data=FF00, CRC)
              读取所有参数    01 03 00 00 00 13 CRC  (ID=1, 功能码=03, 读取起始地址=0000, 读取数量=0013, CRC)
*/ 
...
/* Private variables ---------------------------------------------------------*/
bitfield8  	uCoilsStatusHI;
bitfield8  	uCoilsStatusLO;

bitfield8  	uInputStatusHI;
...
//读开关输入状态	0x02 开关，按键等
uint8_t ucRegDiscreteBuf[REG_DISCRETE_SIZE/8] = {0x51,0x52};
